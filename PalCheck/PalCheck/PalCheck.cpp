...
int main(){
	char *str1 = "arozaupalanalapuazora";
	char  *str2 = "qqqolalofffrerg";
	char *str3 = "ohiqhthjq4j4tjr";

	Tree *tr1 = new Tree(str1);
	Tree *tr2 = new Tree(str2);
	Tree *tr3 = new Tree(str3);

	cout << tr1->IsPal(0, 20) << endl << tr2->IsPal(3, 7) << endl << tr3->IsPal(4, 12);
